...
(function($) {
	...
	/**
	 * Class for table Table Module
	 *
	 * @since 2.5
	 */
	FLBuilderTable = function( settings ){

		// set params
        this.settings = settings;
		this.nodeClass = '.fl-node-' + settings.id;
        this.wrapperClass = this.nodeClass + ' .fl-table';

		// initialize
		this._inittableTable();

	};

	FLBuilderTable.prototype = {
		nodeClass               : '',
		wrapperClass            : '',

		_inittableTable: function(){
		...
		{
			$('.fl-module-table .fl-builder-tooltip-text').fadeOut();
		},
