(function($){
	...
	FLBuilder.registerModuleHelper('table-table', {
	...
	FLBuilder.registerModuleHelper('table_column_form', {

		init: function () {
			var form 				= $('.fl-builder-settings[data-type=table_column_form]'),
				icon 				= form.find('input[name=btn_icon]'),
				moduleSettingsForm 	= $('form.fl-builder-table-settings'),
				featuresSection		= $( '#fl-builder-settings-section-features' ),
				featureToggleButton	= '.fl-builder-tables-toggle-button',
		...
		_togglePricesFeaturesClicked: function () {
			var form = $('.fl-builder-settings[data-type=table_column_form]'),
			priceFeatureButtons = form.find('.fl-builder-tables-toggle-button');
				button = $(this);

			form.find('.fl-tables-icon-row').hide();
			form.find('.fl-tables-tooltip-row').hide();

			if (button.hasClass('down')) {
				button.closest('.fl-tables-field').find('.fl-tables-icon-row').show();
				button.closest('.fl-tables-field').find('.fl-tables-tooltip-row').show();

				form.find('.fl-builder-tables-toggle-button').removeClass('up');
				form.find('.fl-builder-tables-toggle-button').addClass('down');
